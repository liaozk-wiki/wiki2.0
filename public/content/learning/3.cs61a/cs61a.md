...
装饰器模式
![image-20240303135226651](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240303135226651.png)
...
add(add(1,2),add(3,4))
```
![截屏2023-11-17 15.31.36](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/%E6%88%AA%E5%B1%8F2023-11-17%2015.31.36.png)

![image-20231117164309106](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20231117164309106.png)
...
![image-20231120162817764](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20231120162817764.png)

对value的解释，要在环境的定义下才有意义

![image-20231120163243104](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20231120163243104.png)
...
![image-20231123143619210](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20231123143619210.png)
...
![image-20240226223716432](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240226223716432.png)

方法的哲学：
![image-20240228141006784](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240228141006784.png)
...
![image-20240228154947759](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240228154947759.png)
...
![image-20240228163036225](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240228163036225.png)
...
![image-20240228214501479](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240228214501479.png)

尾递归，意味着递归调用之后没有其他操作了。这里虽然只会调用一个is_a_zero但如果为false还会继续 func(middle)...

![image-20240228214717238](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240228214717238.png)

一个很好的例子：need more think

![image-20240228222106367](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240228222106367.png)

计数

![image-20240228222149001](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240228222149001.png)
...
![image-20240303143204878](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240303143204878.png)
...
![image-20240303143803427](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240303143803427.png)
...
![image-20240303145016465](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240303145016465.png)

list于tuple的主要区别：tuple 不可变，list可变！

![image-20240303145126210](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240303145126210.png)
...
![image-20240303150305490](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240303150305490.png)


sequence 的选择与切片


![image-20240303151133406](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240303151133406.png)


sequence 的组合与转换


![image-20240303151315435](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240303151315435.png)


sequence的迭代：循环


![image-20240303151452170](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240303151452170.png)


sequence 的一些其他语法


![image-20240303160546509](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240303160546509.png)
...
![image-20240303171445179](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240303171445179.png)
...
![image-20240307011249339](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240307011249339.png)
...
![image-20240314002612499](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240314002612499.png)
...
![image-20240316094949618](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240316094949618.png)
...
![image-20240316103351424](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240316103351424.png)
...
![image-20240316114744382](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240316114744382.png)

![image-20240316114821852](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240316114821852.png)
...
![image-20240324131310721](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240324131310721.png)
...
![image-20240324135417942](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240324135417942.png)


cond


![image-20240324142432732](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240324142432732.png)


define/lambda


![image-20240324142602775](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240324142602775.png)


“ + - * / quotient”


![image-20240324142835123](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240324142835123.png)


cons car cdr


![image-20240324142918483](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240324142918483.png)


= / eq / eqv / equal


![image-20240324143314996](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240324143314996.png)


let


![image-20240324143756046](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240324143756046.png)


scheme中的递归


![image-20240324144226897](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240324144226897.png)
...
![image-20240324170751088](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240324170751088.png)
...
![image-20240330224024603](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240330224024603.png)
...
![image-20240331000616784](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240331000616784.png)


![image-20240331001709926](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240331001709926.png)
...
![image-20240331131035702](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240331131035702.png)


![image-20240331131109510](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240331131109510.png)


执行程序之前的条件编译


![image-20240331133143534](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240331133143534.png)


是否可以理解为，宏就是提供了一种替换，因为先于程序执行，所以可以替换程序中函数的实现，同时因为是替换，不存在函数中的参数求值，等等


![image-20240331133811032](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240331133811032.png)


![image-20240331135546919](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240331135546919.png)
...
![image-20240401225041588](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240401225041588.png)
...
![image-20240401235223557](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240401235223557.png)
...
![image-20240401235857487](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240401235857487.png)


3与-3的关系是abs


![image-20240402000348943](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240402000348943.png)


![image-20240402000426672](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240402000426672.png)
...
![image-20240402001823853](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240402001823853.png)
...
![image-20240402002832404](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240402002832404.png)
...
![image-20240403012055916](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240403012055916.png)
...
![image-20240403012828332](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240403012828332.png)


惰性匹配


![image-20240403013413586](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240403013413586.png)
...
![image-20240404131527917](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240404131527917.png)

邱奇理论，type 0/1/2

bnf简介

![image-20240404132111052](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240404132111052.png)

Lark

使用bnf定义sentences：

![image-20240404133615286](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240404133615286.png)

数字：可以是一串数字+“，”+ 一个数字 ｜ 一个数字

![image-20240404134558498](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240404134558498.png)

正则表达式无法描述这种括号，bnf范式 描述：

![image-20240404135031083](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240404135031083.png)

BNF的语法结构：

![image-20240404141043605](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240404141043605.png)
...
![image-20240404150732078](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240404150732078.png)
...
![image-20240405141448565](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20240405141448565.png)
