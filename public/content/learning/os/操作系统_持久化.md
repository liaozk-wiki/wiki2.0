...
![image-20250414203327567](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250414203327567.png)
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250415200841352.png" alt="image-20250415200841352" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250415212006016.png" alt="image-20250415212006016" style="zoom:50%;" />
...
- 随便给每个设备定一个端口/地址，用 mux 连接到 CPU 就行
  ...
  <img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250415212728223.png" alt="image-20250415212728223" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250415215741467.png" alt="image-20250415215741467" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250415221245038.png" alt="image-20250415221245038" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250416202957749.png" alt="image-20250416202957749" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250421212951862.png" alt="image-20250421212951862" style="zoom:50%;" />

<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250421213306930.png" alt="image-20250421213306930" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250421215433998.png" alt="image-20250421215433998" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250421220511132.png" alt="image-20250421220511132" style="zoom:50%;" />

<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250421221125680.png" alt="image-20250421221125680" style="zoom:50%;" />

![image-20250421221154126](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250421221154126.png)
...
![image-20250422205121497](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250422205121497.png)
...
![image-20250422215406986](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250422215406986.png)
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250423205002699.png" alt="image-20250423205002699" style="zoom:33%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250423210028976.png" alt="image-20250423210028976" style="zoom:33%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250424210241528.png" alt="image-20250424210241528" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250424220153191.png" alt="image-20250424220153191" style="zoom:50%;" />

FAT：一块集中的区域存放每一块的指针，指针部分的区域可以多处备份。

<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250424220408664.png" alt="image-20250424220408664" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250426125807196.png" alt="image-20250426125807196" style="zoom:50%;" />

inodetable包含所有的inode条目（文件的元数据），小数据直接存放在inode内，大数据通过多级索引到datablock。

<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250425213121025.png" alt="image-20250425213121025" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250426145023648.png" alt="image-20250426145023648" style="zoom:50%;" />

RAID4 

n个bit序列，如何在n1的空间，找到是哪一个bit序列丢失了？ -异或XOR

<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250426150424108.png" alt="image-20250426150424108" style="zoom:50%;" />
...
- 写入任意V1,V2,V3都需要更新D1
  ...
  - <img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250426152229197.png" alt="image-20250426152229197" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250426162212078.png" alt="image-20250426162212078" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250426162753436.png" alt="image-20250426162753436" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250426165853036.png" alt="image-20250426165853036" style="zoom:50%;" />

<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250426170014833.png" alt="image-20250426170014833" style="zoom:50%;" />

### 标准设备

标准设备抽象：暴露给外部的硬件接口+内部的逻辑实现

<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250426165930046.png" alt="image-20250426165930046" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250426172549530.png" alt="image-20250426172549530" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250427212328088.png" alt="image-20250427212328088" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250427212401980.png" alt="image-20250427212401980" style="zoom:50%;" />
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250430142635112.png" alt="image-20250430142635112" style="zoom:50%;" />
...
![image-20250430151823633](https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250430151823633.png)
...
<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250430170835198.png" alt="image-20250430170835198" style="zoom:50%;" />

推荐阅读：andriod runtime 教科书级别

<img src="https://markdownupload.oss-cn-chengdu.aliyuncs.com/md/image-20250430174556629.png" alt="image-20250430174556629" style="zoom:50%;" />
